            ...
            <section className="py-16 bg-gradient-to-r from-amber-700 to-stone-800 text-white">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="http://uerp.test/register" className="bg-amber-400 text-amber-900 px-8 py-4 rounded-lg font-bold text-lg hover:bg-amber-300 transition-colors inline-flex items-center justify-center gap-2">
