      ...
      <section className="py-16 bg-gradient-to-r from-emerald-600 to-orange-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="javascript:void(0)" className="bg-white text-emerald-600 px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-100 transition-colors inline-flex items-center justify-center gap-2">
              <span>Apply Now </span>
